...
REM -PhydraUmcReadOnly=true. Gradle is always read-only for version metadata;
REM this wrapper remains the only path that changes version.properties, the
REM manifest and CHANGELOG.md together.
cd /d "%~dp0"
